...
PROMPT='%{$fg_bold[green]%}┌[%{$fg_bold[cyan]%}%n%{$reset_color%}@%{$fg[green]%}%m%{$reset_color%}%{$fg_bold[green]%}]-(%{$fg_bold[white]%}%~%{$fg_bold[green]%})-$(git_prompt_info)$(svn_prompt_info)$(battery_pct_prompt)
└> % %{$reset_color%}'
